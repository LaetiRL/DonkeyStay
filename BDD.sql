...
CREATE TABLE IF NOT EXISTS `DonkeyStay`.`room` (
  ...
  PRIMARY KEY (`id`, `roomtype_id`, `hometype_id`, `user_id`),
...
START TRANSACTION;
USE `DonkeyStay`;
INSERT INTO `DonkeyStay`.`room` (`id`, `roomtype_id`, `hometype_id`, `title`, `description`, `capacity`, `nb_bedroom`, `nb_bathroom`, `price`, `adress`, `city`, `has_tv`, `has_wifi`, `has_kitchen`, `has_aircon`, `start_dispo`, `end_dispo`, `user_id`) VALUES (1, 1, 2, 'Le manoir Wayne', 'Mon superbe manoir', 4, 2, 2, 150, '1007 Mountain Drive', 'Gotham City', 1, 1, 1, 1, '2022-03-07', '2022-04-07', 1);
INSERT INTO `DonkeyStay`.`room` (`id`, `roomtype_id`, `hometype_id`, `title`, `description`, `capacity`, `nb_bedroom`, `nb_bathroom`, `price`, `adress`, `city`, `has_tv`, `has_wifi`, `has_kitchen`, `has_aircon`, `start_dispo`, `end_dispo`, `user_id`) VALUES (2, 2, 1, 'Superbe appartement en plein Centre-Ville', 'Un appartement cosy', 2, 1, 1, 50, '20 rue somewhere 75020', 'Paris', 0, 1, 1, 0, '2022-03-14', '2022-03-31', 2);
INSERT INTO `DonkeyStay`.`room` (`id`, `roomtype_id`, `hometype_id`, `title`, `description`, `capacity`, `nb_bedroom`, `nb_bathroom`, `price`, `adress`, `city`, `has_tv`, `has_wifi`, `has_kitchen`, `has_aircon`, `start_dispo`, `end_dispo`, `user_id`) VALUES (3, 1, 3, 'Grotte (quasi) aménagée, vue sur mer', 'Une magnifique grotte naturelle aménagée, elle ne vous laissera pas de marbre. Attention : chaussures étanches exigées !', 2, 1, 1, 30, 'Grotte de Pair-non-Pair', 'Bordeau', 0, 0, 0, 0, '2022-03-07', '2023-03-07', 4);
INSERT INTO `DonkeyStay`.`room` (`id`, `roomtype_id`, `hometype_id`, `title`, `description`, `capacity`, `nb_bedroom`, `nb_bathroom`, `price`, `adress`, `city`, `has_tv`, `has_wifi`, `has_kitchen`, `has_aircon`, `start_dispo`, `end_dispo`, `user_id`) VALUES (4, 1, 3, 'Une yourte de luxe dans le Larzac', 'Déja montée, plus qu\'a se poser. Le réchaud est fourni.', 1, 1, 0, 300, 'La Plaine, 12230', 'La Cavalerie', 0, 0, 1, 0, '2022-03-20', '2022-05-20', 3);
